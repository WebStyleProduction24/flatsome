...
<?php  if(is_active_sidebar('shop-sidebar2')){ $colll = 8; } else { $colll = 10; };  ?>
		<div class="col large-<?php echo $colll; ?>">
		<?php
			/**
		...
		<?php
				  if(is_active_sidebar('shop-sidebar2')) {
		?>
		<div class="col large-2 hide-for-medium <?php flatsome_sidebar_classes(); ?>">
			<div id="shop-sidebar" class="sidebar-inner col-inner">
				
				  		<?php dynamic_sidebar('shop-sidebar2'); ?>
